...
Class Career_model extends CI_Model
{
    ...
    function submit_job($department_id, $title, $status, $description, $num_of_positions, $lang, $ip_address, $location)
    {
        $data = array(
        ...
        $query = "INSERT INTO positions (department_id, title, status, description, num_of_positions, lang, ip_address, location, posted_date) VALUES (?, ?, ?, ?, ?, ?, ?, ?, now());";
        $result = $this->db->query($query, $data);
    }
}
?>
