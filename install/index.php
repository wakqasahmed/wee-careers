...
if($_POST) {
	...
	if($core->validate_post($_POST) == true)
	{
      ...
      $redir = str_replace('install/','',$redir); 
			header( 'Location: ' . $redir . 'index.php/careers/options' ) ;
		}
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <?php if(is_writable($db_config_path)){?>
        ...
        <fieldset>
          ...
          <label for="username">Username</label><input type="text" id="username" class="input_text" name="username" required />
          <label for="password">Password</label><input type="password" id="password" class="input_text" name="password" required />
